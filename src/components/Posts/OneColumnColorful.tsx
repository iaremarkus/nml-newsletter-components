export const OneColumnColorful = () => (
  <div className="relative grid grid-cols-1">
    <div className="flex flex-col gap-1 bg-cyan-400 p-6">
      <h2 className="text-3xl uppercase font-bold">3 WAYS TO ENGAGE WITH YOUR REMOTE COWORKERS</h2>
    ...
    <div className="flex flex-col gap-1 bg-sky-500 p-6">
      <h3 className="text-3xl uppercase font-bold">Cameras On</h3>
      <p className="text-xl">
    ...
    <div className="flex flex-col gap-1 bg-cyan-300 p-6">
      <h3 className="text-3xl uppercase font-bold">Stay Connected</h3>
      <p className="text-xl">
    ...
    <div className="flex flex-col gap-1 bg-sky-600 p-6">
      <h3 className="text-3xl uppercase font-bold">Interact Socially</h3>
      <p className="text-xl">
